...
import { createRequest, getRequests, getRequestById, updateRequest, createReviewRequest,updateReviewRequest,acceptRequest, cancelRequest, completeRequest, rejectRequest, getRequestsHistory, getRequestMessages, createRequestMessage, getRequestMessagesByUser, markMessageRead } from "../controllers/requests";
...
route.get("/messages", jwtVerify, getRequestMessagesByUser);
route.put("/messages/:messageId/read", jwtVerify, markMessageRead);
route.put("/review/:id", jwtVerify, zValidator('json', createReviewSchema, zodCb), updateReviewRequest);
